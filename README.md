# PasteNinja_v2.[260618] 隐键客v2 - 抗检测粘贴工具
...
- 2026/06/18
  1. 修复粘贴过程中异常退出后无法再次启动的问题。
  2. 将模拟输入任务改为后台线程执行，减少粘贴时界面卡死的情况。
  3. 修复英文大写输入依赖 CapsLock 导致的键盘状态和大小写错误风险。
  4. 关闭窗口时会正确停止全局快捷键监听。
  5. 优化文本校对逻辑，减少插入或删除字符后整段误标差异的问题。
